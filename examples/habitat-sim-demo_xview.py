...
save_video = True
video_path = './data_collection/x-view/apartment_0_run1/'
video_name = 'data_run_video'
# Set poses file path (corresponding to which data will be extracted)
poses_json = "/media/shubodh/DATA/OneDrive/rrc_projects/2020/DeepGlobalRegistration-Navigation/habitat_all/habitat-sim/examples/data_collection/x-view/apartment_0_run1/xview_poses-replica-apartment_0_run1.json"
# Set to which paths you want to save raw data and visualization data  
raw_data_folder = "./data_collection/x-view/apartment_0_run1/raw_data/" 
viz_data_folder = "./data_collection/x-view/apartment_0_run1/viz_data/"
